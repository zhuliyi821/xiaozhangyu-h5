 ...
 *   POST /api/newcomer/auto-claim         -> 完成+领取一站式 {uid, step}
 */
...
// DB config
$dbHost = "localhost";
$dbName = "dalian_mica178_";
$dbUser = "root";
$dbPass = "4PaB1bqgxHuz1I7FGxRSDmx4";
...
try {
    ...
    echo json_encode(["code" => 500, "msg" => "db_error"]);
    exit;
}
...
if ($action === "init") {
    ...
    try {
        ...
        $pdo->rollBack();
        echo json_encode(["code" => 500, "msg" => "init_error"]);
    }
    exit;
}
...
if ($action === "claim") {
    ...
    try {
        ...
        $pdo->rollBack();
        echo json_encode(["code" => 500, "msg" => "claim_error"]);
    }
    exit;
}
...
if ($action === "auto-claim") {
    ...
    try {
        ...
        $pdo->rollBack();
        echo json_encode(["code" => 500, "msg" => "auto_claim_error"]);
    }
    exit;
}
