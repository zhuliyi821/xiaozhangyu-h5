...
const regions: Record<string, Record<string, string[]>> = {
  "北京市": { "北京市": ["东城区", "西城区", "朝阳区", "海淀区", "丰台区", "石景山区", "通州区", "大兴区", "顺义区", "昌平区", "房山区", "门头沟区", "平谷区", "怀柔区", "密云区", "延庆区"] },
  ...
  "重庆市": { "重庆市": ["渝中区", "江北区", "南岸区", "沙坪坝区", "九龙坡区", "大渡口区", "北碚区", "渝北区", "巴南区", "万州区", "涪陵区", "黔江区", "长寿区", "江津区", "合川区", "永川区", "南川区", "綦江区", "大足区", "璧山区", "铜梁区", "潼南区", "荣昌区", "开州区", "梁平区", "武隆区"] },
  "广东省": {
    "广州市": ["越秀区", "荔湾区", "海珠区", "天河区", "白云区", "黄埔区", "番禺区", "花都区", "南沙区", "从化区", "增城区"],
    "深圳市": ["罗湖区", "福田区", "南山区", "盐田区", "宝安区", "龙岗区", "龙华区", "坪山区", "光明区"],
    "珠海市": ["香洲区", "斗门区", "金湾区"],
  ...
  "湖北省": {
    ...
    "随州市": ["曾都区", "广水市", "随县"],
    "恩施市": ["恩施市", "利川市", "建始县", "巴东县", "宣恩县", "咸丰县", "来凤县", "鹤峰县"]
  },
  "四川省": {
  ...
  "河北省": {
    "石家庄市": ["长安区", "桥西区", "新华区", "裕华区", "井陉矿区", "藁城区", "鹿泉区", "栾城区", "晋州市", "新乐市", "井陉县", "正定县", "行唐县", "灵寿县", "高邑县", "深泽县", "赞皇县", "无极县", "平山县", "元氏县", "赵县"],
  ...
  "陕西省": {
    ...
    "咸阳市": ["秦都区", "杨陵区", "渭城区", "兴平市", "三原县", "泾阳县", "乾县", "礼泉县", "永寿县", "长武县", "旬邑县", "淳化县", "武功县", "彬州市"],
  ...
  "安徽省": {
    ...
    "安庆市": ["迎江区", "大观区", "宜秀区", "桐城市", "怀宁县", "太湖县", "宿松县", "望江县", "岳西县", "潜山市"]
  },
  "广西壮族自治区": {
  ...
  "贵州省": {
    ...
    "遵义市": ["红花岗区", "汇川区", "播州区", "赤水市", "仁怀市", "桐梓县", "绥阳县", "正安县", "凤冈县", "湄潭县", "余庆县", "习水县", "道真仡佬族苗族自治县", "务川仡佬族苗族自治县"],
  ...
  "澳门特别行政区": { "澳门": ["花地玛堂区", "圣安多尼堂区", "大堂区", "望德堂区", "风顺堂区", "嘉模堂区", "路氹填海区"] },
