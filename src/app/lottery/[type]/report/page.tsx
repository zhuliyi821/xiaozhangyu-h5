...
export default function PredictionReportPage() {
  ...
  return (
    <main className="min-h-screen bg-bg pb-24">
      ...
      {loading || !prediction ? (
        <div className="p-4 space-y-3">{[1,2,3,4].map(i => <div key={i} className="h-32 bg-surface rounded-[20px] animate-pulse" />)}</div>
      ) : (
        <div className="px-4 mt-3 space-y-3">

          {/* ═══════════ 1. 预测摘要 ═══════════ */}
          <div className="bg-gradient-to-r from-brand-teal to-brand-teal-dark rounded-[20px] p-5 text-white">
          ...
          {/* ═══════════ 2. 推荐组合 ═══════════ */}
          <div className="bg-surface rounded-[20px] p-5 shadow-sm border border-[rgba(69,204,213,0.06)] text-center">
          ...
          <div className="bg-surface rounded-[20px] p-4 shadow-sm border border-[rgba(69,204,213,0.06)]">
            ...
            <div className="grid grid-cols-5 gap-2">
              {["01-07", "08-14", "15-21", "22-28", "29-35"].map((zone, idx) => {
                ...
                return (
                  <div key={zone} className="text-center bg-bg rounded-[12px] p-2">
