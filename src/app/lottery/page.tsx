    ...
    return (
      <main className="min-h-screen bg-bg pb-20">
        <div className="animate-pulse p-4 space-y-4">
          {[1, 2, 3].map(i => <div key={i} className="h-24 bg-gray-100 rounded-[20px]" />)}
        </div>
      </main>
    );
  }
  ...
  return (
    <main className="min-h-screen bg-bg pb-20">
      ...
      <div className="px-4 py-4 space-y-4">
        ...
        {/* 冷热温号 */}
        <div className="bg-white rounded-[20px] p-4 shadow-sm border border-gray-100 space-y-3">
        ...
        {/* AI精选 */}
        <div className="bg-gradient-to-r from-brand-teal/5 to-brand-gold/5 rounded-[20px] p-4 border border-brand-teal/20 shadow-sm">
