  ...
  return (
    <main className="min-h-screen bg-bg pb-24">
      ...
      {!loading && !error && orders.length > 0 && (
        <div className="px-4 mt-4 space-y-3">
          {orders.map((o) => (
            <div key={o.order_sn} className="bg-surface rounded-[20px] p-4 shadow-sm border border-[rgba(69,204,213,0.06)]">
              {/* Header row */}
              ...
              <div className="flex items-center gap-3">
                <div className="w-14 h-14 rounded-[12px] bg-bg flex items-center justify-center text-xl shrink-0 border border-[rgba(69,204,213,0.08)]">
                  {o.order_type === "闲豆" ? "🫘" : "📦"}
                </div>
