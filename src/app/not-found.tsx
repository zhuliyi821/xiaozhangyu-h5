...
export default function NotFoundPage() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[var(--color-surface-off)] p-6 text-center">
      <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-[var(--color-warning)]/10">
      ...
      <h1 className="mb-2 text-4xl font-semibold text-[var(--color-text-primary)]">404</h1>
      <h2 className="mb-2 text-lg font-medium text-[var(--color-text-primary)]">页面不存在</h2>
