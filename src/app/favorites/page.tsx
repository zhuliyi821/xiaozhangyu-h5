      ...
      <div className="bg-gradient-to-br from-brand-teal via-brand-teal-dark to-brand-teal-darkest px-5 pt-4 pb-6 rounded-b-[28px] shadow-soft relative overflow-hidden">
        ...
        <div className="flex items-center gap-2 relative z-10">
          ...
          <div className="flex-1">
            <h1 className="text-[15px] font-medium text-white">我的收藏</h1>
            <p className="text-[10px] text-white/60">收藏心仪商品</p>
          </div>
      ...
      <div className="px-4 -mt-3 relative z-20">
        {loading && (
          <div className="space-y-3 mt-4">
            {[1, 2, 3].map(i => (
              <div key={i} className="bg-surface rounded-[8px] p-4 animate-pulse border border-border-tertiary">
        ...
        {error && (
          <div className="mt-4 p-4 bg-red-50 rounded-[8px] text-center">
        ...
        {!loading && !error && items.length === 0 && (
          <div className="mt-6 p-8 text-center bg-surface rounded-[12px] border border-border-tertiary">
        ...
        {!loading && !error && items.length > 0 && (
          <div className="mt-4 space-y-3">
            {items.map(item => (
              <div key={item.id} className="bg-surface rounded-[8px] p-4 shadow-sm border border-border-tertiary flex items-center gap-3">
